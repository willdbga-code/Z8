...
int main() {
    @autoreleasepool {
        ...
        // Top Gradient
        NSGradient *topGrad = [[NSGradient alloc] initWithStartingColor:[NSColor colorWithRed:0 green:0 blue:0 alpha:0.95]
                                                           endingColor:[NSColor colorWithRed:0 green:0 blue:0 alpha:0.0]];
        [topGrad drawInRect:NSMakeRect(0, 0, width, 560) angle:90];
        ...
        [botGrad drawInRect:NSMakeRect(0, height - 480, width, 480) angle:90];
        ...
        [@"EXPANSÃO VALE DO PARAÍBA." drawAtPoint:NSMakePoint(76, 100) withAttributes:headlineAttrs];
        ...
        [@"FRANQUIA Z8 // EXCLUSIVIDADE DE PRAÇA // MARGEM +50%" drawAtPoint:NSMakePoint(76, 195) withAttributes:subAttrs];
        ...
        [@"Buscamos parceiros estratégicos em Taubaté, Jacareí, Pindamonhangaba e Região." drawAtPoint:NSMakePoint(76, 250) withAttributes:citiesAttrs];

        // 4. Tag Matriz (Bottom Left)
        NSRect tagRect = NSMakeRect(76, height - 140, 420, 56);
        ...
        NSDictionary *tagAttrs = @{
            NSFontAttributeName: [NSFont systemFontOfSize:18 weight:NSFontWeightBlack],
            NSForegroundColorAttributeName: [NSColor colorWithRed:0.95 green:0.85 blue:0.4 alpha:1.0]
        };
        [@"LOJA MATRIZ OFICIAL • Z8 TANK" drawAtPoint:NSMakePoint(110, height - 128) withAttributes:tagAttrs];

        // 5. CTA Badge (Bottom Right)
        CGFloat badgeW = 480;
        CGFloat badgeH = 68;
        NSRect badgeRect = NSMakeRect(width - badgeW - 60, height - 146, badgeW, badgeH);
        ...
        NSDictionary *ctaAttrs = @{
            NSFontAttributeName: [NSFont fontWithName:@"Impact" size:28] ?: [NSFont boldSystemFontOfSize:28],
        ...
        NSPoint ctaPt = NSMakePoint(width - badgeW - 60 + (badgeW - ctaSize.width)/2, height - 146 + (badgeH - ctaSize.height)/2);
        ...
        NSString *out1 = @"/Users/apple/Desktop/Z8/site-principal/public/images/franchise/franquia_matriz_z8tank_3x4_50.jpg";
        NSString *out2 = @"/Users/apple/.gemini/antigravity/brain/1e8470d9-4fdd-478d-acdb-5d3e2c5aa6a6/franquia_matriz_z8tank_3x4_50.jpg";
